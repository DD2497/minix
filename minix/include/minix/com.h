 ...
 *   0x1B00 - 0x1BFF	Myserver
 *   0x1C00 - 0x1CFF	Mpserver
 *
...
#define MPSERVER_PROC_NR  ((endpoint_t) 12)  /* mpatch server */
...
/*===========================================================================*
 *			Messages for MPSERVER				     *
 *===========================================================================*/

#define MPSERVER_BASE 0x1C00

#define MPSERVER_SYS1		(MPSERVER_BASE + 0)	/* Syscall 1 */
#define MPSERVER_SYS2		(MPSERVER_BASE + 1)	/* Syscall 2 */
